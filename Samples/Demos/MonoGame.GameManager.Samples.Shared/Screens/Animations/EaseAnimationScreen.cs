    ...
    public class EaseAnimationScreen : Screen
    {
        ...
        public override void OnInit()
        {
            BreadcrumbNavigation.CreateBreadcrumbNavigation(new List<(string text, Action openScreen)>
            {
                ...
                ("Ease Animation", OpenEaseAnimationScreen)
            });
        ...
        public static void OpenEaseAnimationScreen()
        {
            ServiceProvider.ScreenManager.ChangeScreen(new EaseAnimationScreen());
        }
        ...
        private void CreateOptionsSection()
        {
            ...
            posY += 55;
            Vector2Option.CreateVector2Option(container, "Position Start", posY, easeAnimationPreview.PositionStart, value => easeAnimationPreview.SetPositionStart(value));
            posY += 55;
            ...
            posY += 55;
            CheckboxOption.CreateCheckboxOption(container, "Reverse", posY, easeAnimationPreview.IsReverse, value => easeAnimationPreview.SetIsReverse(value));
            posY += 55;
            CheckboxOption.CreateCheckboxOption(container, "Ping-Pong", posY, easeAnimationPreview.IsPingPong, value => easeAnimationPreview.SetIsPingPong(value));
            posY += 55;
        ...
        private void UpdatePlayStopButtonLabel()
        {
            ...
            playStopLabel.Text = easeAnimationPreview.IsPlaying
                ? "Stop"
                : "Play";
        }
        ...
        private void CreatePreviewSection()
        {
            ...
            var easeAnimationContainer = new Panel(new Rectangle(0, labelContainerMarginTop, (int)container.Size.X, (int)(container.Size.Y - labelContainerMarginTop)))
                .AddToScreen(container);

            new RectangleControl(Vector2.Zero, easeAnimationContainer.Size, new Color(15, 15, 15))
